    ...
    const [] = await Product.create(
        {
            ...
            title: 'Lenovo',
            price: 500,
            description: 'Характеристики ; Гарантия. 1 год ; Диагональ/разрешение. 15.6"/1366x768 пикс. ; Процессор. Intel Celeron N3350 1.1 ГГц ; Оперативная память (RAM). 4 ГБ ',
        ...
        },
        {
            ...
            price: 500,
            description: 'CPU. У обоих 10 ядер, но в Max более высокие тактовые частоты. Следовательно, обеспечивается более высокая производительность в задачах, которые требуют многозадачности и вычислительной мощности.',
        ...
        },
        {
            ...
            title: 'ДУХОВОЙ ШКАФ ',
            price: 5000,
            description: 'Духовка электрическая независимая\n' +
                'Объём 58 л\n' +
        ...
        },
        {
            ...
            price: 5000,
            description: 'Управление электронное\n' +
